...
export async function createPurchaseOrder(supabase, values) {
  ...
  if (!values.shipmentConfigurationId || !values.shipmentPackageType) throw new Error('Shipment configuration and package are required');
