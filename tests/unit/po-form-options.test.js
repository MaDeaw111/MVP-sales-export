...
const configurations = [
  ...
  { id: 'bag-25', is_active: true, shipment_mode: 'Container', container_type: "20'", package: 'Bag 25 kg', package_type: 'BAG_25KG', jumbobag_id: null, bags_per_container: null, standard_mt_per_container: 20, jumbobag_master: null },
  ...
  { id: 'bulk-liner', is_active: true, shipment_mode: 'Container', container_type: "20'", package: 'Bulk Container + Liner', package_type: 'BULK_CONTAINER_LINER', jumbobag_id: null, bags_per_container: null, standard_mt_per_container: 20, jumbobag_master: null },
...
describe('PO form dependent selector options', () => {
  it('lists active shipment types and the configured container types', () => {
    ...
    expect(listContainerTypes(configurations, 'Container').map(({ value }) => value)).toEqual(["20'"]);
  });
